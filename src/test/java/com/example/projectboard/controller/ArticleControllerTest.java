...
class ArticleControllerTest {
    ...
    public void givenNothing_whenRequestingArticlesView_thenReturnsArticlesView() throws Exception {
        ...
        given(paginationService.getPaginationBarNumbers(anyInt(), anyInt())).willReturn(List.of(0, 1, 2, 3, 4)); // any는 null도 들어가서 안 됨
...
//                .andExpect(content().contentType(MediaType.TEXT_HTML)) // Exact match
    ...
    @Test
    public void givenKeyword_whenSearchWithKeyword_thenReturnsArticlesView() throws Exception {
        // Given
...
//                .andExpect(content().contentType(MediaType.TEXT_HTML)) // Exact match
    ...
    @Test
    void givenPagingAndortingParams_whenSearchingArticlesPage_thenReturnsArticlesPage() throws Exception {
        // Given
    ...
    @DisplayName("[view][GET] 게시글 해시태그 페이지 - 정상 호출, 해시태그 입력") // Navigation bar로 만들 예정
    @Test
