...
class ArticleCommentServiceTest {
    ...
    @Test
    void givenNoneExistingArticle_whenSavingArticleComment_thenLogsSituationAndDoNothing() {
        // Given
        ArticleCommentDto dto = createArticleCommentDto("comment");
    ...
    @DisplayName("없는 댓글 정보를 수정하려고 하면, 경고 로그를 찍고 아무것도 하지 않는다.")
    @Test
    void givenNoneExistingArticleComment_whenUpdatingArticleComment_thenLogsWarningAndDoNothing() {
        // Given
